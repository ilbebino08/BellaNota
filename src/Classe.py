...
class Classe:
    def __init__(self, nomeClasse, parent_dir):
        ...
        self.parent_dir = os.path.join(parent_dir, nomeClasse)
    ...
    def __selezionaAlunno(self):                                                                        # Seleziona un profilo alunn* e avvia il menu dell'alunno
        while True:
            ...
            filepath = os.path.join(self.parent_dir, nome_file)                                         # Crea il percorso completo del file

            if os.path.exists(filepath):                                                                # Controlla se il file del profilo esiste
                mioAlunno = Alunno(filepath, nome, cognome)                                              # Avvia il menu dell'alunno per il profilo selezionato
    ...
    def __elencaAlunni(self):                                                                           # Visualizza la lista degli alunni nella classe
        files = os.listdir(self.parent_dir)                                                             # Ottiene la lista di tutti i file nella directory della classe
    ...
    def __gMedia(self):                                                                                 # Calcola e visualizza la media generale di tutta la classe
        media_generale = Funzioni.mediacl(self.parent_dir, "g")                                         # Chiama la funzione "mediacl"
    ...
    def __pMedia(self):                                                                                 # Calcola e visualizza la media pratica di tutta la classe
        media_pratica = Funzioni.mediacl(self.parent_dir, "p")                                          # Chiama la funzione "mediacl"
    ...
    def __oMedia(self):                                                                                 # Calcola e visualizza la media orale di tutta la classe
        media_orale = Funzioni.mediacl(self.parent_dir, "o")                                            # Chiama la funzione "mediacl"
    ...
    def __nCompito(self):                                                                               # Aggiunge un compito di classe
        ...
        Funzioni.compito(self.parent_dir, data, tipo)                                                   # Se il tipo di compito inserito è valido, chiama la funzione "compito" del modulo "Funzioni" per aggiungere il compito alla classe
